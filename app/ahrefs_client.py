    ...
    try:
        resp = requests.get(
            ...
            params={
                ...
                "country": country,
                "limit": limit,
                "select": "raw_url,top_keyword_best_position_title,keywords",
                "order_by": "keywords:desc",
            },
            headers={"Authorization": f"Bearer {api_key}", "Accept": "application/json"},
            timeout=15,
        )
                ...
                return [
                    {
                        ...
                        "traffic": p.get("keywords", 0),
                        "title": p.get("top_keyword_best_position_title", p.get("title", "")),
                    }
                    for p in pages
